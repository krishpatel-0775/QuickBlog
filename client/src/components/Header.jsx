  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      ...
      <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500">
        ...
        write without filters. Whather it's one word or a thousand, your story
        starts right here.
      </p>
      ...
      <div className="text-center">
          {input && <button onClick={onClear} className="border font-light text-xs my-3 py-1 px-3 rounded-sm shadow-custom-sm cursor-pointer">Clear Search</button>}
      </div>
